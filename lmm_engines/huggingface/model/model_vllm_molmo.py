...
class VLLMMolmoAdapter(BaseModelAdapter):
    """The model adapter for DummyImageModel"""
    

    def match(self, model_path: str):
        return "vllm" in model_path.lower() and "molmo" in model_path.lower()
    ...
    def load_model(self, model_path: str, device:str="cuda", from_pretrained_kwargs: dict={}):
        ...
        worker_addr, proc = launch_vllm_worker(
            ...
            num_gpus=1,
            additional_args=[
                "--max-model-len", "4096", "--tokenizer-mode", "auto",
                ],
        )
...
if __name__ == "__main__":
    ...
    from PIL import Image
    model_path = "vllm/allenai/Molmo-7B-D-0924"
    device = "cuda"
    model_adapter = VLLMMolmoAdapter()
    test_adapter(model_adapter, model_path, device)
    
"""
# local testing
python -m lmm_engines.huggingface.model.model_vllm_molmo
# connect to wildvision arena
bash start_worker_on_arena.sh "vllm/allenai/Molmo-7B-D-0924" 21311
"""